...
mod tests {
    ...
    #[test]
    fn test_debugger_call_oob_fn_idx() {
        let module = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
    ...
    #[test]
    fn test_debugger_tailcall_oob_fn_idx_terminator() {
        let module = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
                ...
                blocks: vec![U30Block {
                    ops: vec![],
                    terminator: U30Terminator::TailCall { function: 99, args: vec![] },
                }],
                entry_block: 0,
            }],
            entry_function: 0,
        };
        // Verify passes (TailCall fn idx is a register, resolved at runtime)
        let mut dbg = U30Debugger::new(module, &[], 1000).unwrap();
        // Runtime fails: function 99 doesn't exist
        let r = dbg.run_to_completion();
        assert!(r.is_err());
    }

    #[test]
    fn test_debugger_binary_add_wrap_u32() {
        let module = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
    ...
    #[test]
    fn test_debugger_binary_mul_wrap_u32() {
        let module = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
    ...
    #[test]
    fn test_debugger_binary_sub_wrap_u32() {
        let module = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
    ...
    #[test]
    fn test_debugger_binary_and_u8() {
        let module = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
                ...
                blocks: vec![U30Block {
                    ops: vec![
                        U30Op::Const { dst: 0, value: U30Value::U8(0b1100) },
                        U30Op::Const { dst: 1, value: U30Value::U8(0b1010) },
                        U30Op::Binary { dst: 2, op: U30BinaryOp::AndU8, a: 0, b: 1 },
                    ],
                    terminator: U30Terminator::Ret { values: vec![2] },
                }],
    ...
    #[test]
    fn test_debugger_binary_xor_u8() {
        let module = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
    ...
    #[test]
    fn test_debugger_binary_shl_u32() {
        let module = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
    ...
    #[test]
    fn test_debugger_binary_shr_u32() {
        let module = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
                ...
                blocks: vec![U30Block {
                    ops: vec![
                        U30Op::Const { dst: 0, value: U30Value::U32(0b110000) },
    ...
    #[test]
    fn test_debugger_binary_div_u32() {
        let module = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
    ...
    #[test]
    fn test_debugger_binary_rem_u32() {
        let module = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
    ...
    #[test]
    fn test_debugger_binary_min_u32() {
        let module = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
                ...
                blocks: vec![U30Block {
                    ops: vec![
                        U30Op::Const { dst: 0, value: U30Value::U32(10) },
                        U30Op::Const { dst: 1, value: U30Value::U32(20) },
                        U30Op::Binary { dst: 2, op: U30BinaryOp::MinU32, a: 0, b: 1 },
                    ],
                    terminator: U30Terminator::Ret { values: vec![2] },
                }],
                entry_block: 0,
    ...
    #[test]
    fn test_debugger_binary_max_u32() {
        let module = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
                ...
                blocks: vec![U30Block {
                    ops: vec![
                        U30Op::Const { dst: 0, value: U30Value::U32(10) },
                        U30Op::Const { dst: 1, value: U30Value::U32(20) },
                        U30Op::Binary { dst: 2, op: U30BinaryOp::MaxU32, a: 0, b: 1 },
                    ],
                    terminator: U30Terminator::Ret { values: vec![2] },
                }],
                entry_block: 0,
    ...
    #[test]
    fn test_debugger_binary_le_u32() {
        let module = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
                ...
                blocks: vec![U30Block {
                    ops: vec![
                        U30Op::Const { dst: 0, value: U30Value::U32(10) },
                        U30Op::Const { dst: 1, value: U30Value::U32(20) },
                        U30Op::Binary { dst: 2, op: U30BinaryOp::LeU32, a: 0, b: 1 },
                    ],
                    terminator: U30Terminator::Ret { values: vec![2] },
                }],
                entry_block: 0,
    ...
    #[test]
    fn test_debugger_indirectcall_oob_fn_idx() {
        let module = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
    ...
    #[test]
    fn test_debugger_call_bad_arg_reg() {
        let module = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![
                ...
                U30Function {
                    ...
                    blocks: vec![U30Block {
                        ops: vec![
                            U30Op::Call { function: 0, args: vec![999], results: vec![] },
                        ],
                        terminator: U30Terminator::Ret { values: vec![] },
                    }],
                    entry_block: 0,
    ...
    #[test]
    fn test_debugger_tailcall_bad_arg_reg() {
        let module = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![
                ...
                U30Function {
                    ...
                    blocks: vec![U30Block {
                        ops: vec![],
                        terminator: U30Terminator::TailCall { function: 0, args: vec![999] },
                    }],
                    entry_block: 0,
                },
            ],
    ...
    #[test]
    fn test_debugger_tailcall_undefined_result() {
        // TailCall where result register is undefined (too high index)
        let module = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
                ...
                blocks: vec![U30Block {
                    ops: vec![],
                    terminator: U30Terminator::Ret { values: vec![9999] },
                }],
                entry_block: 0,
            }],
            entry_function: 0,
        };
        // Note: verify doesn't catch undefined result registers; just check arity
        let r = U30Debugger::new(module, &[], 1000);
        assert!(r.is_ok());
    }

    #[test]
    fn test_debugger_i64_f64() {
        let module = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
    ...
    #[test]
    fn test_debugger_reinterpret_f64_u64() {
        let module = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
    ...
    #[test]
    fn test_debugger_reinterpret_u64_f64() {
        let module = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
                ...
                blocks: vec![U30Block {
                    ops: vec![
                        U30Op::Const { dst: 0, value: U30Value::U64(0x3FF8000000000000u64) },
                        U30Op::ReinterpretU64F64 { dst: 1, src: 0 },
                    ],
                    terminator: U30Terminator::Ret { values: vec![1] },
                }],
    ...
    #[test]
    fn test_debugger_trunc_u64_u16() {
        let module = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
                ...
                blocks: vec![U30Block {
                    ops: vec![
                        U30Op::Const { dst: 0, value: U30Value::U64(0x1_0000) },
    ...
    #[test]
    fn test_debugger_trunc_u32_u16() {
        let module = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
    ...
    fn test_debugger_sext_i16_u32() {
        let module = U30Module {
            ...
            functions: vec![U30Function {
                ...
                blocks: vec![U30Block {
                    ops: vec![
                        U30Op::Const { dst: 0, value: U30Value::U16(0xFFFF) },
    ...
    fn test_debugger_sext_i32_u64() {
        let module = U30Module {
            ...
            functions: vec![U30Function {
                ...
                blocks: vec![U30Block {
                    ops: vec![
                        U30Op::Const { dst: 0, value: U30Value::U32(0x80000001) }, // negative i32
    ...
    fn test_debugger_zext_i32_u64() {
        let module = U30Module {
            ...
            functions: vec![U30Function {
                ...
                blocks: vec![U30Block {
                    ops: vec![
                        U30Op::Const { dst: 0, value: U30Value::U32(0xFFFFFFFF) },
        ...
        let module = U30Module {
            ...
            functions: vec![U30Function {
                ...
                blocks: vec![U30Block {
                    ops: vec![
                        U30Op::Const { dst: 0, value: U30Value::F64(3.0) },
                        U30Op::Const { dst: 1, value: U30Value::F64(1.0) },
                        U30Op::F64Min { dst: 2, a: 0, b: 1 },
                    ],
                    terminator: U30Terminator::Ret { values: vec![2] },
                }],
    ...
    #[test]
    fn test_debugger_memsize() {
        let module = U30Module {
            regions: vec![U30RegionDecl { id: 0, size: 4096, readable: true, writable: true, initial: vec![] }],
            tables: vec![],
            functions: vec![U30Function {
                params: vec![],
                results: vec![U30Type::U64],
    ...
    #[test]
    fn test_debugger_memgrow_bad_delta_type() {
        // MemGrow with delta that is not U64 (F64)
        let module = U30Module {
            regions: vec![U30RegionDecl { id: 0, size: 4096, readable: true, writable: true, initial: vec![] }],
            tables: vec![],
            functions: vec![U30Function {
                ...
                blocks: vec![U30Block {
                    ops: vec![
                        U30Op::Const { dst: 0, value: U30Value::F64(1.0) }, // not U64
                        U30Op::MemGrow { dst: 1, region: 0, delta: 0 },
                    ],
                    terminator: U30Terminator::Ret { values: vec![] },
                }],
    ...
    #[test]
    fn test_debugger_memsize_bad_region() {
        // MemSize with nonexistent region
        let module = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
                ...
                blocks: vec![U30Block {
                    ops: vec![
                        U30Op::MemSize { dst: 0, region: 99 }, // nonexistent
                    ],
                    terminator: U30Terminator::Ret { values: vec![0] },
                }],
                entry_block: 0,
        ...
        // Verification catches nonexistent region at construction
        let r = U30Debugger::new(module, &[], 1000);
        assert!(r.is_err());
    }

    #[test]
    fn test_debugger_call_args_not_defined() {
        // Call with undefined argument register
        let module = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![
                ...
                U30Function {
                    ...
                    blocks: vec![U30Block {
                        ops: vec![
                            U30Op::Const { dst: 1, value: U30Value::U64(0) }, // r1 defined
                            U30Op::Call { function: 0, args: vec![999], results: vec![] }, // r999 undefined
                        ],
                        terminator: U30Terminator::Ret { values: vec![] },
                    }],
                    entry_block: 0,
    ...
    #[test]
    fn test_debugger_tailcall_args_not_defined() {
        // TailCall with undefined argument register
        let module = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![
                ...
                U30Function {
                    ...
                    blocks: vec![U30Block {
                        ...
                        terminator: U30Terminator::TailCall { function: 0, args: vec![999] }, // r999 undefined
                    }],
                    entry_block: 0,
                },
            ],
    ...
    #[test]
    fn test_debugger_indirectcall_bad_arg_type() {
        // IndirectCall with wrong type for function register — verification doesn't catch type errors at call time
        let module = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
        ...
        // Verification accepts it (type errors not caught at construction), execution would fail
        let r = U30Debugger::new(module, &[], 1000);
        assert!(r.is_ok());
    }

    #[test]
    fn test_debugger_tablebr_invalid_index_reg() {
        // TableBr where index register contains wrong type
        let module = U30Module {
            regions: vec![],
            tables: vec![U30TableDecl { id: 0, targets: vec![1] }],
            functions: vec![U30Function {
                ...
                blocks: vec![
                    U30Block {
                        ops: vec![
                            U30Op::Const { dst: 0, value: U30Value::F64(0.0) }, // F64, not U64
                            U30Op::TableBr { table: 0, index: 0 }, // reads r0 as index
                        ],
                        terminator: U30Terminator::Ret { values: vec![] },
                    },
                    U30Block {
        ...
        // Verification doesn't catch type errors in TableBr index — accepts but would fail at runtime
        let r = U30Debugger::new(module, &[], 1000);
        assert!(r.is_ok());
    }

    #[test]
    fn test_debugger_assert_failure() {
    ...
    #[test]
    fn test_debugger_binary_invalid_a_reg() {
        // Binary with undefined register 'a'
        let module = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
                ...
                blocks: vec![U30Block {
                    ops: vec![
                        U30Op::Const { dst: 1, value: U30Value::U64(20) },
                        U30Op::Binary { dst: 2, op: U30BinaryOp::AddWrapU64, a: 999, b: 1 },
                    ],
                    terminator: U30Terminator::Ret { values: vec![2] },
                }],
                entry_block: 0,
    ...
    #[test]
    fn test_debugger_binary_type_mismatch() {
        // Binary with wrong types (U64 + F64)
        let module = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
    ...
    #[test]
    fn test_debugger_indirectcall_result_reg_oob() {
        // IndirectCall where result register is undefined (too high)
        let module = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![
                ...
                U30Function {
                    ...
                    blocks: vec![U30Block {
                        ops: vec![
                            U30Op::Const { dst: 0, value: U30Value::U64(1) },
                            U30Op::IndirectCall { function: 0, args: vec![], results: vec![9999] },
                        ],
                        terminator: U30Terminator::Ret { values: vec![] },
                    }],
                    entry_block: 0,
        ...
        let r = U30Debugger::new(module, &[], 1000);
        assert!(r.is_ok()); // verify doesn't catch undefined result reg
    }

    #[test]
    fn test_debugger_not_u8_wrong_type() {
        // NotU8 with wrong type (F64)
        let module = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
    ...
    #[test]
    fn test_debugger_not_u16_wrong_type() {
        let module = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
    ...
    #[test]
    fn test_debugger_not_u32_wrong_type() {
        let module = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
    ...
    #[test]
    fn test_debugger_not_u64_wrong_type() {
        let module = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
    ...
    #[test]
    fn test_debugger_i2f_wrong_type() {
        let module = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
    ...
    #[test]
    fn test_debugger_f2i_wrong_type() {
        let module = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
    ...
    #[test]
    fn test_debugger_memcopy_oob_dst() {
        let module = U30Module {
            regions: vec![
                U30RegionDecl { id: 0, size: 16, readable: true, writable: true, initial: vec![0; 16] },
                U30RegionDecl { id: 1, size: 16, readable: true, writable: true, initial: vec![0; 16] },
            ...
            functions: vec![U30Function {
                ...
                blocks: vec![U30Block {
                    ops: vec![
                        U30Op::Const { dst: 0, value: U30Value::U64(0) },  // src offset
                        U30Op::Const { dst: 1, value: U30Value::U64(14) }, // dst offset OOB
                        U30Op::Const { dst: 2, value: U30Value::U64(4) },  // size
                        U30Op::MemCopy { dst_region: 1, dst_offset: 1, src_region: 0, src_offset: 0, size: 2 },
                    ],
                    terminator: U30Terminator::Ret { values: vec![] },
                }],
                entry_block: 0,
        ...
        // Bounds checked at runtime, not at construction
        let mut dbg = U30Debugger::new(module, &[], 1000).unwrap();
        let r = dbg.run_to_completion();
        assert!(r.is_err()); // OOB: 14+4 = 18 > 16
    }

    #[test]
    fn test_debugger_memfill_wrong_value_type() {
        let module = U30Module {
            regions: vec![U30RegionDecl { id: 0, size: 16, readable: true, writable: true, initial: vec![0; 16] }],
            tables: vec![],
            functions: vec![U30Function {
                ...
                blocks: vec![U30Block {
                    ops: vec![
                        U30Op::Const { dst: 0, value: U30Value::U64(0) },
                        U30Op::Const { dst: 1, value: U30Value::F64(42.0) }, // wrong type
    ...
    // === F64 binary operations (execute_op match arms: F64Eq, F64Lt, F64Gt, F64Le, F64Ge, F64Add, F64Sub, F64Mul, F64Div, F64Min, F64Max) ===
    #[test]
    fn test_debugger_f64eq_works() {
        let m = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
    ...
    #[test]
    fn test_debugger_f64lt_gt_le_ge() {
        // F64Lt: 2.0 < 5.0
        let m = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
                ...
                blocks: vec![U30Block {
                    ops: vec![
                        U30Op::Const { dst: 0, value: U30Value::F64(2.0) },
                        U30Op::Const { dst: 1, value: U30Value::F64(5.0) },
                        U30Op::F64Lt { dst: 2, a: 0, b: 1 },
                    ],
                    terminator: U30Terminator::Ret { values: vec![2] },
                }],
    ...
    #[test]
    fn test_debugger_f64add_sub_mul_div() {
        // F64Add: 1.5 + 2.5 = 4.0
        let m = U30Module {
            regions: vec![],
            tables: vec![],
        ...
        assert!(result.is_some());
        match result.unwrap() {
            U30Value::F64(v) => assert!((*v - 4.0).abs() < 1e-10),
            other => panic!("expected F64(4.0), got {:?}", other),
        }
        ...
        assert!(result.is_some());
        match result.unwrap() {
            U30Value::F64(v) => assert!((*v - 3.0).abs() < 1e-10),
            other => panic!("expected F64(3.0), got {:?}", other),
        }
        ...
        assert!(result.is_some());
        match result.unwrap() {
            U30Value::F64(v) => assert!((*v - 12.0).abs() < 1e-10),
            other => panic!("expected F64(12.0), got {:?}", other),
        }
    ...
    #[test]
    fn test_debugger_f64sqrt_abs_neg_min_max() {
        // F64Sqrt: sqrt(16.0) = 4.0
        let m = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
        ...
        assert!(result.is_some());
        match result.unwrap() {
            U30Value::F64(v) => assert!((*v - 7.5).abs() < 1e-10),
            other => panic!("expected F64(7.5), got {:?}", other),
        }
        ...
        assert!(result.is_some());
        match result.unwrap() {
            U30Value::F64(v) => assert!((*v - (-3.5)).abs() < 1e-10),
            other => panic!("expected F64(-3.5), got {:?}", other),
        }

        // F64Min: min(2.0, 5.0) = 2.0
        let m = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
        ...
        assert!(result.is_some());
        match result.unwrap() {
            U30Value::F64(v) => assert!((*v - 2.0).abs() < 1e-10),
            other => panic!("expected F64(2.0), got {:?}", other),
        }

        // F64Max: max(2.0, 5.0) = 5.0
        let m = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
        ...
        assert!(result.is_some());
        match result.unwrap() {
            U30Value::F64(v) => assert!((*v - 5.0).abs() < 1e-10),
            other => panic!("expected F64(5.0), got {:?}", other),
        }
    }

    // === F64 conversions (execute_op: I64F64, F64I64, F32F64, F64F32, ReinterpretF64U64, ReinterpretU64F64) ===
    #[test]
    fn test_debugger_f64_conversions() {
        // I64F64: U64(99) -> F64(99.0)
        let m = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
        ...
        assert!(result.is_some());
        match result.unwrap() {
            U30Value::F64(v) => assert!((*v - 99.0).abs() < 1e-10),
            other => panic!("expected F64(99.0), got {:?}", other),
        }

        // F64I64: F64(42.7) -> U64(42)
        let m = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
                ...
                blocks: vec![U30Block {
                    ops: vec![
                        U30Op::Const { dst: 0, value: U30Value::F64(42.7) },
                        U30Op::F64I64 { dst: 1, src: 0 },
                    ],
                    terminator: U30Terminator::Ret { values: vec![1] },
                }],
        ...
        assert!(result.is_some());
        match result.unwrap() {
            U30Value::F64(v) => assert!((*v - 3.5).abs() < 1e-6),
            other => panic!("expected F64(3.5), got {:?}", other),
        }

        // F64F32: F64(2.25) -> F32(2.25)
        let m = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
                ...
                blocks: vec![U30Block {
                    ops: vec![
                        U30Op::Const { dst: 0, value: U30Value::F64(2.25) },
                        U30Op::F64F32 { dst: 1, src: 0 },
                    ],
                    terminator: U30Terminator::Ret { values: vec![1] },
                }],
        ...
        assert!(result.is_some());
        match result.unwrap() {
            U30Value::F32(v) => assert!((*v - 2.25_f32).abs() < 1e-6),
            other => panic!("expected F32(2.25), got {:?}", other),
        }

        // ReinterpretF64U64: read F64 bits as U64 (1.0 = 0x3FF0_0000_0000_0000)
        let m = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
        ...
        assert!(result.is_some());
        match result.unwrap() {
            U30Value::U64(v) => assert_eq!(*v, 0x3FF0_0000_0000_0000u64),
            other => panic!("expected U64(0x3FF0...), got {:?}", other),
        }

        // ReinterpretU64F64: read U64 bits as F64
        let m = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
                ...
                blocks: vec![U30Block {
                    ops: vec![
                        U30Op::Const { dst: 0, value: U30Value::U64(0x3FF0_0000_0000_0000u64) },
                        U30Op::ReinterpretU64F64 { dst: 1, src: 0 },
                    ],
                    terminator: U30Terminator::Ret { values: vec![1] },
                }],
        ...
        assert!(result.is_some());
        match result.unwrap() {
            U30Value::F64(v) => assert!((*v - 1.0).abs() < 1e-10),
            other => panic!("expected F64(1.0), got {:?}", other),
        }
    }

    // === SExt variants (execute_op: SExtI8U16, SExtI8U32, SExtI8U64, SExtI16U32, SExtI16U64, SExtI32U64) ===
    #[test]
    fn test_debugger_sext_variants() {
        // SExtI8U16: sign-extend U8(128) = 0x80 to U16(0xFF80)
        let m = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
                ...
                blocks: vec![U30Block {
                    ops: vec![
                        U30Op::Const { dst: 0, value: U30Value::U8(128) },
                        U30Op::SExtI8U16 { dst: 1, src: 0 },
                    ],
                    terminator: U30Terminator::Ret { values: vec![1] },
                }],
        ...
        assert!(result.is_some());
        match result.unwrap() {
            U30Value::U16(v) => assert_eq!(*v, 0xFF80),
            other => panic!("expected U16(0xFF80), got {:?}", other),
        }

        // SExtI8U32: U8(200) = 0xC8 as i8 = -56, sign-extended to i32 = 0xFFFFFFC8
        let m = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
                ...
                blocks: vec![U30Block {
                    ops: vec![
                        U30Op::Const { dst: 0, value: U30Value::U8(200) },
                        U30Op::SExtI8U32 { dst: 1, src: 0 },
                    ],
                    terminator: U30Terminator::Ret { values: vec![1] },
                }],
        ...
        assert!(result.is_some());
        match result.unwrap() {
            U30Value::U32(v) => assert_eq!(*v, 0xFFFFFFC8),
            other => panic!("expected U32(0xFFFFFFC8), got {:?}", other),
        }

        // SExtI8U64: U8(128) -> 0xFFFFFFFFFFFFFF80
        let m = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
        ...
        assert!(result.is_some());
        match result.unwrap() {
            U30Value::U64(v) => assert_eq!(*v, 0xFFFFFFFFFFFFFF80),
            other => panic!("expected U64(0xFFFFFFFFFFFFFF80), got {:?}", other),
        }
        ...
        let m = U30Module {
            ...
            functions: vec![U30Function {
                ...
                blocks: vec![U30Block {
                    ops: vec![
                        U30Op::Const { dst: 0, value: U30Value::U16(0x8000) },
                        U30Op::SExtI16U32 { dst: 1, src: 0 },
                    ],
                    terminator: U30Terminator::Ret { values: vec![1] },
                }],
        ...
        assert!(result.is_some());
        match result.unwrap() {
            U30Value::U32(v) => assert_eq!(*v, 0xFFFF8000),
            other => panic!("expected U32(0xFFFF8000), got {:?}", other),
        }
        ...
        assert!(result.is_some());
        match result.unwrap() {
            U30Value::U64(v) => assert_eq!(*v, 0xFFFFFFFFFFFF8000),
            other => panic!("expected U64(0xFFFFFFFFFFFF8000), got {:?}", other),
        }
        ...
        let m = U30Module {
            ...
            functions: vec![U30Function {
                ...
                blocks: vec![U30Block {
                    ops: vec![
                        U30Op::Const { dst: 0, value: U30Value::U32(0x80000000) },
                        U30Op::SExtI32U64 { dst: 1, src: 0 },
                    ],
                    terminator: U30Terminator::Ret { values: vec![1] },
                }],
        ...
        assert!(result.is_some());
        match result.unwrap() {
            U30Value::U64(v) => assert_eq!(*v, 0xFFFFFFFF80000000),
            other => panic!("expected U64(0xFFFFFFFF80000000), got {:?}", other),
        }
    }

    // === eval_binary error paths (wrong type) ===
    #[test]
    fn test_debugger_binary_wrong_type() {
        // Binary op with wrong types — triggers eval_binary ? error paths
        // AddWrapU32 with U64 input should fail
        let m = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
        ...
        // AndU8 with U32 input should fail
        let m = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
                ...
                blocks: vec![U30Block {
                    ops: vec![
                        U30Op::Const { dst: 0, value: U30Value::U32(0xF0) },
                        U30Op::Const { dst: 1, value: U30Value::U32(0x0F) },
                        U30Op::Binary { dst: 2, op: U30BinaryOp::AndU8, a: 0, b: 1 },
                    ],
                    terminator: U30Terminator::Ret { values: vec![2] },
                }],
    ...
    // === eval_binary: more error paths for remaining ? branches ===
    #[test]
    fn test_debugger_binary_subwrap_wrong_type() {
        // SubWrapU64 with F64 input — triggers as_u64() error path
        let m = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
        ...
        // SubWrapU32 with U64 input — triggers as_u32() error path
        let m = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
    ...
    #[test]
    fn test_debugger_binary_mulwrap_wrong_type() {
        // MulWrapU64 with F64 input
        let m = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
    ...
    #[test]
    fn test_debugger_binary_u8_wrong_type() {
        // OrU8 with U32 input — as_u8() rejects U32
        let m = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
        ...
        let m = U30Module {
            ...
            functions: vec![U30Function {
                ...
                blocks: vec![U30Block {
                    ops: vec![
                        U30Op::Const { dst: 0, value: U30Value::U16(0xF0) },
                        U30Op::Const { dst: 1, value: U30Value::U16(0x0F) },
                        U30Op::Binary { dst: 2, op: U30BinaryOp::XorU8, a: 0, b: 1 },
                    ],
                    terminator: U30Terminator::Ret { values: vec![2] },
                }],
    ...
    #[test]
    fn test_debugger_binary_shift_wrong_type() {
        // ShlU64 with Bool input — as_u64() rejects Bool
        let m = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
                ...
                blocks: vec![U30Block {
                    ops: vec![
                        U30Op::Const { dst: 0, value: U30Value::U64(1) },
                        U30Op::Const { dst: 1, value: U30Value::Bool(true) },
                        U30Op::Binary { dst: 2, op: U30BinaryOp::ShlU64, a: 0, b: 1 },
                    ],
                    terminator: U30Terminator::Ret { values: vec![2] },
                }],
        ...
        // ShlU32 with U64 input — as_u32() rejects U64
        let m = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
        ...
        let m = U30Module {
            ...
            functions: vec![U30Function {
                ...
                blocks: vec![U30Block {
                    ops: vec![
                        U30Op::Const { dst: 0, value: U30Value::U64(8) },
                        U30Op::Const { dst: 1, value: U30Value::Bool(true) },
                        U30Op::Binary { dst: 2, op: U30BinaryOp::ShrU64, a: 0, b: 1 },
                    ],
                    terminator: U30Terminator::Ret { values: vec![2] },
    ...
    #[test]
    fn test_debugger_binary_divrem_wrong_type() {
        // DivU64 with F64 input
        let m = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
    ...
    // === process_terminator: test TailCall error path ===
    #[test]
    fn test_debugger_tailcall_invalid_fn() {
        // TailCall to non-existent function index should fail
        let m = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
    ...
    // === DebugState load/store OOB error paths ===
    #[test]
    fn test_debugger_load_u64_oob_new() {
        // LoadU64: offset from register, offset=16 beyond 8-byte region
        let m = U30Module {
            regions: vec![U30RegionDecl {
                id: 0,
                size: 8,
            ...
            functions: vec![U30Function {
                ...
                blocks: vec![U30Block {
                    ops: vec![
                        U30Op::Const { dst: 0, value: U30Value::U32(16) }, // r0 = 16 (offset)
                        U30Op::LoadU64 { dst: 1, region: 0, offset: 0 },    // use r0 as offset → OOB
                    ],
                    terminator: U30Terminator::Ret { values: vec![1] },
                }],
                entry_block: 0,
    ...
    #[test]
    fn test_debugger_store_u16_oob_new() {
        // StoreU16: offset from register, 3+2=5 > 4 → OOB
        let m = U30Module {
            regions: vec![U30RegionDecl {
                id: 0,
                size: 4,
            ...
            functions: vec![U30Function {
                ...
                blocks: vec![U30Block {
                    ops: vec![
                        U30Op::Const { dst: 0, value: U30Value::U16(0xABCD) }, // r0 = value
                        U30Op::Const { dst: 1, value: U30Value::U32(3) },     // r1 = offset 3 (OOB: 3+2 > 4)
                        U30Op::StoreU16 { region: 0, offset: 1, src: 0 },
                    ],
                    terminator: U30Terminator::Ret { values: vec![] },
                }],
                entry_block: 0,
    ...
    // === mem_copy and mem_fill OOB paths (MemCopy/MemFill use registers for offset/size/value) ===
    #[test]
    fn test_debugger_memcopy_oob() {
        // MemCopy with src beyond boundary — src_offset=20 on 16-byte region is OOB
        let m = U30Module {
            regions: vec![U30RegionDecl {
                id: 0,
                size: 16,
            ...
            functions: vec![U30Function {
                ...
                blocks: vec![U30Block {
                    ops: vec![
                        ...
                        U30Op::Const { dst: 1, value: U30Value::U32(20) },  // src_offset = 20 (OOB)
    ...
    #[test]
    fn test_debugger_memfill_oob_new() {
        // MemFill: offset=10, size=4 on 8-byte region — 10+4=14 > 8 → OOB
        let m = U30Module {
            regions: vec![U30RegionDecl {
                id: 0,
                size: 8,
            ...
            functions: vec![U30Function {
                ...
                blocks: vec![U30Block {
                    ops: vec![
                        U30Op::Const { dst: 0, value: U30Value::U32(10) }, // offset = 10
    ...
    // === eval_binary: remaining error paths ===
    #[test]
    fn test_debugger_binary_or_wrong_type() {
        // OrU8 with U32 input — as_u8() rejects U32
        let m = U30Module {
            regions: vec![],
            tables: vec![],
        ...
        // XorU8 with U16 input — as_u8() rejects U16
        let m = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
    ...
    #[test]
    fn test_debugger_binary_shift_divrem_wrong_type() {
        // ShlU32 with U64 input — as_u32() rejects U64
        let m = U30Module {
            regions: vec![],
            tables: vec![],
        ...
        // ShrU64 with Bool input — as_u64() rejects Bool
        let m = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
        ...
        // ShrU32 with U64 input — as_u32() rejects U64
        let m = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
        ...
        // DivU64 with F64 input — as_u64() rejects F64
        let m = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
        ...
        // DivU32 with U64 input — as_u32() rejects U64
        let m = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
        ...
        // RemU64 with Bool input — as_u64() rejects Bool
        let m = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
        ...
        // RemU32 with U64 input — as_u32() rejects U64
        let m = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
    ...
    // === eval_binary: LtU64/GtU64/GeU64/LeU64/LeU32 error paths ===
    #[test]
    fn test_debugger_binary_cmp_wrong_type() {
        // LtU64 with F64 input
        let m = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
        ...
        // LeU32 with U64 input — as_u32() rejects U64
        let m = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
    ...
    // === process_terminator: BrIf error path ===
    #[test]
    fn test_debugger_brif_undefined_cond() {
        // BrIf with undefined condition register — triggers process_terminator ? branch
        let m = U30Module {
            regions: vec![],
            tables: vec![],
            functions: vec![U30Function {
                ...
                blocks: vec![
                    U30Block {
                        ops: vec![],
                        terminator: U30Terminator::BrIf { cond: 99, then_target: 1, else_target: 0 },
                    },
                    U30Block {
                        ops: vec![],
                        terminator: U30Terminator::Ret { values: vec![] },
